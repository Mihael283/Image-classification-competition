...
class EfficientNet(nn.Module):
    ...
    def __init__(self, param, num_classes=20, stem_channels=32, feature_size=1280, drop_connect_rate=0.2):
        ...
        # stem convolution
        self.stem_conv = _Conv3x3Bn(1, stem_channels, 2)
...
def MyCNN():
    return EfficientNet(net_param['efficientnet-b3'])
